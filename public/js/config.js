(function(){
  const Config = {
    ...
    BUILD: '20260124-final-privileges-settings',
    APP: {
      shortName: 'MUMS',
    ...
    teamById(id){
      // Super Admin accounts may intentionally have no team/shift assignment.
      if(!id) return { id:'', label:'All Teams', teamStart:'00:00', teamEnd:'23:59', dutyStart:'00:00', dutyEnd:'23:59' };
