(function(){
  const Config = {
    ...
    // ============================================================
    // THEME SYSTEM - CLEANED AND SIMPLIFIED
    // ============================================================
    // Only 2 premium themes remain for enterprise consistency.
    // Super Admin can set global default theme for all users.
    ...
    // NEW: manage_global_theme permission added for Super Admin
    PERMS: {
      SUPER_ADMIN: ['*','create_users','view_logs','view_my_record','view_gmt_overview','view_distribution_monitoring','manage_global_theme'],
